Ext.define('Bsg.view.company.PartnersGrid',{
	extend: 'Ext.grid.Panel',
	cls: 'grid-box',
	xtype: 'partnersgrid',
	alias: 'widget.PartnersGrid',

	initComponent: function(){
		var me = this;

		me.title = 'Ключевые партнеры';
		me.hideHeaders = true;
		me.columns = [{
			text: 'Наименование',
			dataIndex: 'name',
		...
		me.tools = [{
			...
			type:'plus',
			tooltip: 'Добавить ключевого партнера',
			handler: function(){
				me.fireEvent('onaddpartner', me);
			}
		}];
