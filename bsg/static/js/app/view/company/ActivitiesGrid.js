Ext.define('Bsg.view.company.ActivitiesGrid',{
	...
	initComponent: function(){
		...
		me.title = 'Ключевые виды деятельности';
		me.hideHeaders = true;
		me.columns = [{
			text: 'Наименование',
			dataIndex: 'name',
		...
		me.tools = [{
			...
			type:'plus',
			tooltip: 'Добавить ключевой вид деятельности',
			handler: function(){
				me.fireEvent('onaddactivities', me);
			}
		}];
